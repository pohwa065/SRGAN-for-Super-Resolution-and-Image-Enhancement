...
class SRGAN():
    def __init__(self):
        # Input shape
        self.channels = 3
        self.lr_height = 320                 # Low resolution height
        ...
        json_file = open('generator5300.json', 'r')
        loaded_model_json = json_file.read()
        json_file.close()
        self.generator = model_from_json(loaded_model_json)
        # load weights into new model
        self.generator.load_weights("generator5300_weight.hdf5")
        print("Loaded model from disk")


        #load a discriminator

        json_file = open('discriminator5300.json', 'r')
        loaded_model_json = json_file.read()
        json_file.close()
        self.discriminator = model_from_json(loaded_model_json)
        # load weights into new model
        self.discriminator.load_weights("discriminator5300_weight.hdf5")
        print("Loaded model from disk")
