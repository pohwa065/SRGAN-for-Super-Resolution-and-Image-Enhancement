...
import sys
from data_loader4 import DataLoader
import numpy as np
import os
...
class SRGAN():
    def __init__(self):
        ...
        self.data_loader4 = DataLoader(dataset_name=self.dataset_name,
    ...
    def train(self, epochs, batch_size=10, sample_interval=50):
        ...
        for epoch in range(epochs):
            ...
            imgs_hr, imgs_lr = self.data_loader4.load_data(batch_size)
    ...
    def sample_images(self, epoch):
        ...
        imgs_hr, imgs_lr = self.data_loader4.load_data(batch_size=102, is_testing=True)
        fake_hr = self.generator.predict(imgs_lr)
        ...
        dir = 'Model_Gen/origin/%s'
        dir2 ='Model_Gen/random/%s'
        dir3 ='Model_Gen/random_lr/%s'
